...
Font* j1Fonts::LoadFont(const char* path, const char* name, int size)
{
	Font* font = new Font();

	TTF_Font* ttf_font = TTF_OpenFontRW(App->fs->Load(path), 1, size);
...
Font* j1Fonts::GetFont(const char* name)
{
	Font* ret = nullptr;
