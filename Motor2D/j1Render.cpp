...
// Blit to screen
bool j1Render::Blit(SDL_Texture* texture, int x, int y, const SDL_Rect* section, float alpha, float _scale, bool use_camera, SDL_RendererFlip flip, double angle, int pivot_x, int pivot_y) const
{
	bool ret = true;
